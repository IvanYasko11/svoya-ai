...
V1.8 — реальный Tool Layer через GitHub MCP с минимальными правами, чтением/изменением репозитория через отдельный контур и повторной проверкой результата.
